...
const Testimonials = () => {
    return (
        <div>
              <section class="testimonial  w-75 m-auto text-center">
                ...
                <div class="mt-5 d-flex justify-content-between testimonials ">
                    <div class="testimonial-details rounded mb-5 p-3 d-flex">
